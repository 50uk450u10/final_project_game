...
public class SettingsManager : MonoBehaviour
{
    ...
    {
        if (SceneManager.GetSceneByName("GameplayTestScene 1").isLoaded && !SceneManager.GetSceneByName("PauseMenu").isLoaded)
        {
        ...
        else if (SceneManager.GetSceneByName("DifficultyMenu").isLoaded)
        {
            SceneManager.UnloadSceneAsync("DifficultyMenu");
        }
    }
}
